...
def gap_call(S, X1, X2, T, rf, div_yld, vol):
    """
...
def gap_put(S, X1, X2, T, rf, div_yld, vol):
    """
...
if __name__ == "__main__":
    # Example usage:
    print(gap_call(S=50, X1=50, X2=57, T=0.5, rf=0.09, div_yld=0, vol=0.2))
    print(gap_put(S=100, X1=100, X2=95, T=1, rf=0.05, div_yld=0, vol=0.2))
