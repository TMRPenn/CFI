...
def path_sim(args):
    ...
    end_stk = path[-1]
    hit_indicator = 1 if indicator else 0
...
def anti_path_sim(args):
    ...
    end_stk_1 = path_1[-1]
    hit_indicator_1 = 1 if indicator_1 else 0
    ...
    end_stk_2 = path_2[-1]
    hit_indicator_2 = 1 if indicator_2 else 0

    # Averaging the results from both paths
    avg_hit_indicator = (hit_indicator_1 + hit_indicator_2) / 2
    avg_end_stk = (end_stk_1 + end_stk_2) / 2
    
    return avg_hit_indicator, avg_end_stk
